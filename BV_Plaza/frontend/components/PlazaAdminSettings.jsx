...
const PlazaAdminSettings = ({ toast }) => {
  ...
  useEffect(() => {
    Promise.all([
      apiPlazaGetSetting().then(r => setSetting(r.data.setting || {})),
      apiPlazaAdminGetStalls().then(r => setStalls(r.data.stalls || [])),
      apiPlazaAdminWithdrawals().then(r => setWithdrawals(r.data.withdrawals || [])),
